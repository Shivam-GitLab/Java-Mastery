...
public class IntermediateOps02 {
    public static void main(String[] args) {
        ...
        Stream<String> stringStream2 = list.stream().map((x) -> (x.toLowerCase()));
        Stream<String> stringStream3 = list.stream().map((x) -> (x.toLowerCase(Locale.ROOT)));
        System.out.println("Stream 1 = "+stringStream1.toList());
        System.out.println("Stream 2 = "+stringStream2.toList());
        System.out.println("Stream 3 = "+stringStream3.toList());
